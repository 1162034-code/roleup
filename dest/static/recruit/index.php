        ...
        <div class="p-content-card__inner">
          <div class="p-content-card__head">
            ...
            <div class="p-content-card__icon">
              <img src="[theme_dir]/assets/img/common/icon/circle_fist.webp" alt="" width="44" height="44">
            </div>
          </div>
      ...
      <li class="p-content-card -bg-alpha js-fade-in">
        <div class="p-content-card__inner">
          <div class="p-content-card__head">
            ...
            <div class="p-content-card__icon">
              <img src="[theme_dir]/assets/img/common/icon/circle_glow.webp" alt="" width="44" height="44">
            </div>
          </div>
          <div class="p-content-card__body">
      ...
      <li class="p-content-card -bg-alpha js-fade-in">
        <div class="p-content-card__inner">
          <div class="p-content-card__head">
            ...
            <div class="p-content-card__icon">
              <img src="[theme_dir]/assets/img/common/icon/circle_reward.webp" alt="" width="44" height="44">
            </div>
          </div>
          <div class="p-content-card__body">
      ...
      <li class="p-content-card -bg-alpha js-fade-in">
        <div class="p-content-card__inner">
          <div class="p-content-card__head">
            ...
            <div class="p-content-card__icon">
              <img src="[theme_dir]/assets/img/common/icon/circle_diamond.webp" alt="" width="44" height="44">
            </div>
          </div>
          <div class="p-content-card__body">
...
<section id="entry" class="recruit-entry">
  <div class="recruit-entry__inner c-container">
    ...
    <div class="recruit-entry__btn-wrap">
      <a href="[home_url]/contact/" class="c-btn-gradient-gold c-btn-size-lg c-btn-arrow-right">
