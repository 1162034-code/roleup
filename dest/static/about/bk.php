    ...
    <div class="about-president__body">
      ...
      <div class="about-president__media js-fade-in">
        <div class="about-president__img">
          <picture>
            <source media="(max-width: 768px)" srcset="[theme_dir]/assets/img/page/about/president_img_01_sp.webp" width="335" height="223">
            <img src="[theme_dir]/assets/img/page/about/president_img_01.webp" width="380" height="507" alt="写真：渡邉 達也">
          </picture>
        </div>
      </div>
    </div>
...
<section id="member" class="about-member">
  <div class="about-member__inner c-container">
    ...
    <p class="about-member__lead js-fade-in"><span class="u-br-tab">公認会計士、税理士、M&Aアドバイザーなど、</span>各分野のプロフェッショナルがチームを組み、クライアントの課題解決に取り組みます。</p>
      ...
      <ul class="about-member__grid">
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal1">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_01.webp" width="274" height="365" alt="">
            </span>
        ...
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal2">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_02.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
        ...
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal3">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_03.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
              <span class="about-member__card-position">取締役</span>
      ...
      <ul class="about-member__grid -four">
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal4">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_04.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
        ...
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal5">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_05.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
        ...
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal6">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_06.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
        ...
        <li class="about-member__card">
          <button type="button" class="about-member__card-btn p-modal-trigger js-modal-trigger" data-modal="modal7">
            <span class="about-member__card-img">
              <img src="[theme_dir]/assets/img/page/about/member_07.webp" width="274" height="365" alt="">
            </span>
            <span class="about-member__card-info">
              <span class="about-member__card-position">M&Aアドバイザー</span>
...
<dialog id="modal1" aria-labelledby="modalTitle1" aria-describedby="modalDesc1" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal2" aria-labelledby="modalTitle2" aria-describedby="modalDesc2" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal3" aria-labelledby="modalTitle3" aria-describedby="modalDesc3" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal4" aria-labelledby="modalTitle4" aria-describedby="modalDesc4" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal5" aria-labelledby="modalTitle5" aria-describedby="modalDesc5" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal6" aria-labelledby="modalTitle6" aria-describedby="modalDesc6" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
...
<dialog id="modal7" aria-labelledby="modalTitle7" aria-describedby="modalDesc7" class="p-modal js-modal js-simplebar">
  <div class="about-member -modal">
    <div class="about-member__card-img">
      <img src="[theme_dir]/assets/img/page/about/modal_img_01.webp" width="283" height="188" alt="">
    </div>
